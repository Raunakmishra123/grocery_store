...
<!-- login -->
				...
				<div class="module form-module">
                    ...
                    <div class="form">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="text" name="City" placeholder="Pincode " required style="">
       ...
       pattern="^[A-Za-z!@#$%^&*()_+\-=\[\]{};':\"\\|,.?/]{8}$" 
       title="Password must be exactly 8 characters long and can include uppercase, lowercase letters, and symbols (except < and >).">
